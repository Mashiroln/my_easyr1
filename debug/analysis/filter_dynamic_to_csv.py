...
csv_path = os.path.join(out_root, "group_stats_cot_norm_sft3ep.csv")
csv_out_path = os.path.join(out_root, f"group_stats_filtered_{diversity_threshold}_sft3ep.csv")
